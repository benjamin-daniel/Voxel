...
export default class Player {
  ...
  look = (horizontal, vertical, z) => {
    this.touchX = horizontal;
    this.touchY = vertical;
    this.scene.lookAt(this.touchY, this.touchX);
    console.log({ horizontal, vertical, z });
  };
  ...
  onGesture = (event, gestureState, type) => {
    ...
    switch (type) {
      ...
      case GestureType.moved:
        this.look(gestureState.dx, gestureState.dy, gestureState.dz);
        break;
